...
const AboutUsPage = () => {
  return (
    <div className="about-us">
      {/* Wrap the header with FadeInSection */}
      <FadeInSection>
      ...
      {/* Wrap the leadership team section with FadeInSection */}
      <FadeInSection>
      ...
      {/* Wrap the "Loved By Parents Locally" section with FadeInSection */}
      <FadeInSection>
        <section>
      ...
      {/* Wrap the testimonials section with FadeInSection */}
      <FadeInSection>
