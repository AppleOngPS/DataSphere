...
const Homepage = () => (
  ...
  <div className="hero-section">
    <FadeInSection>
      ...
      <div className="hero-section">
        <div className="overlay">
          <img
            src={homeImg}
            alt="Mindsphere Conference"
            className="hero-image"
          />
          <div className="hero-text">
            <div className="headline">
              <p className="headline-line1">
                Learn Impactful Speaking Skills From
              </p>
              <p className="headline-line2">Seasoned Speakers</p>
            </div>
    ...
    {/* Our Story section (with fade-in effect) */}
    <FadeInSection>
      <section className="about-section">
        ...
        <p>
          ...
          effective teaching with workforce relevance in mind. Regardless how
          you define success, we believe every learner deserves a chance at it.
          We uphold the highest standards of integrity and ethics, and more than
          a learning hub, we are a community committed to fostering growth,
          inspiring confidence, and nurturing the leaders of tomorrow. We
          welcome you onboard our journey to shape the future, one mind at a
          time.
        </p>
      </section>
    </FadeInSection>

    {/* Our Learning Approach section (with fade-in effect) */}
    <FadeInSection>
    ...
    {/* About Us section (with fade-in effect) */}
    <FadeInSection>
      <div className="about-us">
        ...
        <section className="leadership-team">
          ...
          <div className="team-info">
            ...
            <p>
              ...
              international partnerships. He holds a Bachelor of Arts in
              Business Management from Kingston University and has pursued:
              <ul>
                <li>
              ...
              Singapore&apos;s top real estate agencies, rising through the
              ranks to Board of Director and Chief Operating Officer where he
              trained thousands of real estate agents and team leaders. He
              spearheaded integration efforts during OTT&apos;s merger and
              acquisition, integrating over 95% of the salesforce, exceeding
              1,000 salespeople.
              <br />
              <br />
              Always up for a challenge, Simon left OTT to become Managing
              Director at Singapore&apos;s first geospatial technology company
              Mogul.sg, securing a significant public-private partnership with
              the Ministry of National Development, marking a significant
              milestone in Singapore&apos;s real estate industry. This pioneer
              initiative sets a new standard for industry-government cooperation
              and drives sustainable urban development strategies.
              <br />
              <br />
            ...
            <p>
              ...
              Melbourne Institute of Technology, Christine embodies
              multi-talent; she started teaching at the tender age of 17 and
              with patience as her strongest virtue, she advocates inclusive
              education for both neurotypical and special needs children. For
              close to 20 years now, she pursues her passion as an educator
              fervently, with an inclination towards guiding students who
              struggle with passing exams to eventually pass with flying colors.
              ...
              their careers. She has impacted over 10,000 students to date.
              <br />
              <br />
              ...
              complementarily, enabling her to become the bridge between
              employers and the future pillars of our economy.
            </p>
          </div>
        </section>

        {/* Loved By Parents Locally section (with fade-in effect) */}
        <FadeInSection>
          <section>
        ...
        {/* Testimonials section (with fade-in effect) */}
        <FadeInSection>
          <section className="testimonials">
            <div className="testimonials-container">
              ...
              <div className="main-testimonial">
                ...
                <blockquote>
                  <p>
                    &quot;From the time they joined, the growth has been
                    amazing. Improving confidence, boosting grades—it all feels
                    like magic.&quot;
                  </p>
