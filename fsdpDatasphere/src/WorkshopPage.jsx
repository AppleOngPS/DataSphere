  ...
  const programmes = [
    {
      ...
      testimonials: [
        ...
        {
          quote:
            "It was my absolute pleasure to attend a leadership training conducted by Simon Yio, the esteemed former COO of OrangeTee back then in 2022. Simon's adeptness in engaging every participant truly set his training apart. His clear, relatable messages, undoubtedly honed by his experience as a trained Toastmasters speaker, resonated deeply with all of us. Simon not only encouraged lively interaction among participants but also facilitated thought-provoking and enjoyable activities.",
    ...
    },
    {
      ...
      testimonials: [
        ...
        {
          quote:
            "My child made significant progress in understanding difficult concepts. Highly recommended!",
          name: "Henry Tan",
        },
        {
    ...
    },
    {
      ...
      testimonials: [
        ...
        {
          quote:
            "Great insights and practical skills that I could apply immediately in my job.",
          name: "Rachel Ong",
        },
      ],
    },
