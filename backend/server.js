...
const programController = require("./controllers/programController");
const programScheduleController = require("./controllers/programScheduleController");
const programmeCardController = require("./controllers/programmeCardController"); // Import programmeCard controller
const webhookController = require("./controllers/webhookController");
const clerkClientMiddleware = require("./middlewares/clerkClientMiddleware");
...
// BookingDetails Routes
app.post("/bookingDetails", bookingDetailsController.createBookingDetail);
app.get(
  "/bookingDetails/:bookingID",
  bookingDetailsController.getBookingDetailsByBookingID
);
